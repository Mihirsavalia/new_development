...
const CompaniesModal = ({ onOpen, onClose, onConnectQb, onConnectXero }: any) => {
  return (
    <>
<div>
        <Modal
        ...
        >
          <ModalTitle>
            <div className="py-3 px-4 flex flex-col">
              ...
              <Typography className="text-gray-600 pb-1">
                Select the accounting tool to connect the company.
              </Typography>
            </div>
          ...
          <ModalContent>
            <div className="p-2 flex flex-row justify-center m-3">
              <div className="max-w-sm overflow-hidden border-gray-300 border-[1px] p-2 h-full w-full mr-6 mb-2 rounded flex flex-col items-center">
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSv26TvCWusuQWjAAuncGhTg094aGaTBr9x1w&usqp=CAU"
                  alt="quickbook_logo"
                  className="w-20 h-20"
                />
                <Typography className="text-gray-600 p-2">
                  QuickBooks Online
                </Typography>
                <Button
                  className="rounded-full btn-sm font-semibold mx-2 my-3 !w-auto !h-[36px]"
                  variant="btn-primary"
                  onClick={onConnectQb}
              ...
              <div className="max-w-sm overflow-hidden border-gray-300 border-[1px] p-2 h-full w-full mr-6 mb-2 rounded flex flex-col items-center">
                <img
                  ...
                  className="w-20 h-20"
                />
                <Typography className="text-gray-600 p-2">Xero</Typography>
                <Button
                  className="rounded-full btn-sm font-semibold mx-2 my-3 !w-auto !h-[36px]"
                  variant="btn-primary"
              ...
              <div className="max-w-sm overflow-hidden border-gray-300 border-[1px] p-2 h-full w-full mb-2 rounded flex flex-col items-center">
                <img
                  ...
                  className="w-20 h-20"
                />
                <Typography className="text-gray-600 p-2">Sage Intacct</Typography>
                <Button
                  className="rounded-full btn-sm font-semibold mx-2 my-3 !w-auto !h-[36px]"
                  variant="btn-primary"
                  // onClick={onConnect}
